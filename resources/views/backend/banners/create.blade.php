                        ...
                        <div class="body mt-5">
                            ...
                            <div class="form-group mt-5 row">
                                ...
                                <div class="col-10">
                                    ...
                                    {{-- <input class="form-control" type="file" name="logos" placeholder="Please Select Image"
                            ...
                            <div class="form-group mt-5 row">
                                ...
                                <div class="col-10">
                                    <textarea class="summernote" name="short_text" placeholder="Enter Your Short Text">{{ old('short_text') }}</textarea>
                                </div>
                            </div>
                            <div class="form-group mt-5 row">
                                ...
                                <div class="col-10">
                                    <div class="toggle-class_true checked custom-control custom-switch"><input
                                            type="checkbox" name="status" class="custom-control-input"
                                            id="status"><label class="custom-control-label" for="status"></label></div>
                                </div>
                            </div>
                            <div class="mt-5">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#close").on("click", function() {
                let name = $("#image").attr('name');
                console.log(name);
                $(`#${name}`).parent().find('.dropify-clear').trigger('click');
