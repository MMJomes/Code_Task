                    ...
                    <form action={{ route('backend.banner.update', $banner->id) }} method="POST"
                        ...
                        <div class="media photo">
                            ...
                            <div class="media-body">
                                ...
                                <button type="button" class="btn btn-default-dark" id="btn-upload-photo">Upload
                                    Photo</button>
                                <input type="file" name="image" value="{{ old('image',$banner->image) }}" id="filePhoto"
                        ...
                        <div class="form-group mt-5 row">
                            <label for="example-text-input" class="col-2 col-form-label">Short Text <span
                                    class="required">*</span></label>
                            <div class="col-10">
                                <textarea class="form-control" name="short_text" placeholder="Enter Your Short Text">{{ old('short_text',$banner->short_text) }}</textarea>
                            </div>
                        </div>
                        <div class="mt-5">
