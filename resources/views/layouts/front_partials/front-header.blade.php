    ...
    <nav class="navbar corporex-navbar navbar-01">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="javascript:;" onclick="gotohomePage()"><img src="{{ url('logo/Logo-dev-test.svg') }}"
                        alt="corporex logo" style="width: 55%"></a>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog Grid
                                    Fullwidth</a>
                                <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog Overlay
                                    Fullwidth</a>
                                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown menu-large">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                            aria-haspopup="true" aria-expanded="false">Shortcodes</a>
                        <ul class="dropdown-menu megamenu row">
